...
- Comprueba que la enfermedad encaje con la especie antes de planificar contra ella. El oídio, por ejemplo, es de plantas de hoja — muy típico en evónimo (Euonymus), rosales, cucurbitáceas y vid — mientras que las coníferas como el ciprés de Leyland no lo padecen: a ellas les afecta el chancro por Seiridium, el amarronamiento por Phytophthora, la seca por Pestalotiopsis o el pulgón del ciprés (Cinara cupressi). Si lo que declara el dueño no cuadra con esa planta, NO le sigas la corriente: dilo en el motivo y propón lo que de verdad explique los síntomas. Esto es para corregir imposibles: cuando la enfermedad sea propia de la especie, planifica contra ella sin objeciones.
