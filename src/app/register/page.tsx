  ...
  return (
    <main className="container" style={{ paddingTop: '120px', paddingBottom: '120px', display: 'flex', justifyContent: 'center' }}>
      ...
      <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '45px' }}>
        <h1 className="heading-text suisse" style={{ color: 'var(--color-ink-black)', marginBottom: '15px', fontSize: '45px', lineHeight: '1.1' }}>
          un nuevo<br/>
          jardín.
        </h1>
        ...
        <div style={{ marginTop: '30px', textAlign: 'center' }}>
          ...
          <Link href="/login" style={{ fontSize: '14px', color: 'var(--color-eucalyptus)', textDecoration: 'none' }}>Acceder</Link>
        </div>
      </div>
