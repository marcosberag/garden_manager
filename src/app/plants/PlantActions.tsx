...
export default function PlantActions({ id }: { id: string }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '15px', marginTop: '15px', alignItems: 'center' }}>
      <Link href={`/plants/${id}/edit`} style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--color-eucalyptus)', textDecoration: 'none' }}>
        Editar
      </Link>
